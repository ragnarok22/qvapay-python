...
class PhonePackageSubModule:
    ...
    async def purchase(self, **kwargs: Any) -> Any:
        """Purchase a phone package."""
        response = await self._http.post("store/phone_package", json=kwargs)
        validate_response(response)
...
class DebitCardSubModule:
    ...
    async def list(self) -> Any:
        ...
        response = await self._http.get("store/visa_card")
        validate_response(response)
        payload = response.json()
    ...
    async def purchase(self, **kwargs: Any) -> Any:
        ...
        response = await self._http.post("store/visa_card", json=kwargs)
        validate_response(response)
        return response.json()
...
class GiftCardSubModule:
    ...
    async def catalog(self) -> List[Any]:
        """Get gift cards catalog."""
        response = await self._http.get("store/gift-card")
        validate_response(response)
        payload = response.json()
    ...
    async def get(self, uuid: str) -> Any:
        ...
        response = await self._http.get(f"store/gift-card/{uuid}")
        validate_response(response)
        return response.json()

    async def purchase(self, uuid: str, **kwargs: Any) -> Any:
        """Purchase a gift card item."""
        response = await self._http.post(f"store/gift-card/{uuid}", json=kwargs)
        validate_response(response)
        return response.json()
...
class StoreModule:
    ...
    async def products(self) -> List[Product]:
        ...
        response = await self._http.get("store")
        validate_response(response)
        return [Product.from_json(p) for p in self._data_items(response.json())]

    async def my_purchased(self) -> List[PurchasedProduct]:
    ...
    async def get_purchased(self, uuid: str) -> PurchasedProduct:
        ...
        response = await self._http.get(f"store/my/{uuid}")
        validate_response(response)
